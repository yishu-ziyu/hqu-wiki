...
> **CFPS / CGSS 为受控数据，需向项目组注册获取。** 无法直接提供下载，见下方"受控数据获取"。

- [世界发展指标 WDI](research-data/世界发展指标/README.md) — 世界银行 ~200 国 × 1,400+ 指标

## 受控数据获取

以下数据受项目组使用协议限制，无法在本站直接提供：

| 数据集 | 来源 | 获取方式 |
|--------|------|----------|
| CFPS（中国家庭追踪调查） | 北京大学中国社会科学调查中心 | [注册申请](https://www.isss.pku.edu.cn/cfps/) |
| CGSS（中国综合社会调查） | 中国人民大学中国调查与数据中心 | [注册申请](https://www.cnsda.org) |

> 注册流程大约 1–2 周，通过后免费下载原始数据（.dta / .sav）。如有问题可提 issue。
